  ...
  return (
    <div className="min-h-screen bg-[#FFFFFF] flex flex-col py-12 px-6 lg:px-8">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-[420px]">
        ...
        <p className="text-center text-[16px] text-[#6B6B6B] mb-8">Create your Notion account</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label htmlFor="name" className="block text-[14px] font-medium text-[#37352F] mb-1">
              Name
            </label>
            <input
              id="name"
